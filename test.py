...
if __name__ == '__main__':
    ...
    total_duration = float(ffmpeg.probe("C:\@\Pessoais\Python\mixintube\videos\lula_faz_professores_chorarem.mkv")['format']['duration'])
    ...
    with show_progress(total_duration) as socket_filename:
        ...
        try:
            (ffmpeg
                .input("C:\@\Pessoais\Python\mixintube\videos\lula_faz_professores_chorarem.mkv")
                .colorchannelmixer(*sepia_values)
                .output("C:\@\Pessoais\Python\mixintube\videos\lula_faz_professores_chorarem.webm")
